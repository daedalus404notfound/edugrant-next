...
export default function EditScholarship({
  ...
  return (
    <div>
      <ScrollArea className="h-[80vh] rounded-t-lg relative bg-background ">
        {isActive && (
          <div className="absolute z-10 inset-0 bg-black/70 backdrop-blur-sm"></div>
        )}
        ...
        <Form {...form}>
          {" "}
          <TourStep setterPrev={setMode} setterValuePrev="details" stepId="3">
      ...
      <div className="flex p-4 bg-gradient-to-b backdrop-blur-sm to-card from-card/50 gap-3">
        <TourStep stepId="6" className="flex-1">
          {" "}
          <DeleteDialog
            open={open}
