...
export default function Create() {
  ...
  const postScholarshipTourSteps: TourStepType[] = [
    {
      id: "details",
      title: "Basic Scholarship Details",
      description: "Provide the essential information about the scholarship.",
    },
    {
      id: "files",
      title: "Scholarship Images",
      description:
        "Upload logos, sponsor images, cover details, and any related forms.",
    },
    {
      id: "documents",
      title: "Required Documents",
      description:
        "Specify the documents students need to complete for the scholarship.",
    },
    {
      id: "buttons",
      title: "Form Actions",
      description: "Use the Submit and Clear buttons to manage the form.",
    },
  ];
