...
// import { scholarshipDocumentFormData } from "@/hooks/zod/scholarship";
...
//   rejectedDocuments: Record<string, scholarshipDocumentFormData>
// ) => {
...
//   const rejectedDocuments = Object.entries(data.submittedDocuments.documents)
//     .filter(([, doc]) => {
//       const userDoc = data.submittedDocuments[doc.label];
//       return userDoc?.rejectMessage?.status === "REJECTED";
//     })
//     .reduce((acc, [key, doc]) => {
//       acc[key] = doc;
//       return acc;
//     }, {} as Record<string, scholarshipDocumentFormData>);
