...
export function SummaryCardUser({
  label,
  data,
  icon,
  color,
  ...
  return (
    <div className="dark:border bg-background rounded-lg hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
      <div className=" bg-gradient-to-br dark:to-card to-card/50 dark:from-card/50 from-card/30 shadow z-10 flex flex-col justify-between rounded-lg  lg:p-5 p-4 lg:gap-2 ">
