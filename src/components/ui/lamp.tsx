...
export default function Lamp() {
  return (
    <div className="absolute top-15  isolate z-0 w-screen flex-1 items-start justify-center hidden dark:flex">
      ...
      {/* Main glow */}
      <div className="absolute inset-auto z-50 h-40 w-[28rem] -translate-y-[-30%] rounded-full bg-emerald-800/10 opacity-80 blur-3xl" />
      ...
      <motion.div
        ...
        className="absolute top-0 z-30 h-36 -translate-y-[20%] rounded-full bg-emerald-800/10 blur-2xl"
      />
      ...
      <motion.div
        ...
        transition={{ ease: "easeInOut", delay: 0.8, duration: 1.2 }}
        className="absolute inset-auto z-50 h-0.5 -translate-y-[-10%] bg-emerald-800/40"
      />
      ...
      <motion.div
        ...
        style={{
          backgroundImage:
            "conic-gradient(from 80deg at center top, rgba(16,185,129,0.6), transparent, transparent)",
        }}
      ...
      <motion.div
        ...
        style={{
          backgroundImage:
            "conic-gradient(from 280deg at center top, transparent, transparent, rgba(16,185,129,0.6))",
        }}
